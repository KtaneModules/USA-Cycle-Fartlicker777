...
public class USACycle : MonoBehaviour {
   ...
   string[] LetterAbbreviations = "AK AL AR AZ CA CO CT DE FL GA HI IA ID IL IN KS KY LA ME MD MA MI MN MO MS MT NC ND NB NH NJ NM NV NY OH OK OR PA RI SC SD TN TX UT VA VT WA WV WI WY".Split(' ');
   string[] StateNames = "Alaska,Alabama,Arkansas,Arizona,California,Colorado,Connecticut,Delaware,Florida,Georgia,Hawaii,Iowa,Idaho,Illinois,Indiana,Kansas,Kentucky,Louisiana,Maine,Maryland,Massachusetts,Michigan,Minnesota,Missouri,Mississippi,Montana,North Carolina,North Dakota,Nebraska,New Hampshire,New Jersey,New Mexico,Nevada,New York,Ohio,Oklahoma,Oregon,Pennsylvania,Rhode Island,South Carolina,South Dakota,Tennessee,Texas,Utah,Virginia,Vermont,Washington,West Virginia,Wisconsin,Wyoming".Split(',');
   string GoalWord = "";
   ...
   private KeyCode[] TheKeys =
  {
   ...
   void Start () {
      ...
      } while (GoalWord.Length < 4 || GoalWord.ToUpper().Contains('Q') || GoalWord.ToUpper().Contains('W') || !GoalWord.ToUpper().Contains('I'));
